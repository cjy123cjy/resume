...
\begin{itemize}[parsep=0.5ex]
  ...
  \item Frontend: React
  \item Others: Mysql, Redis, Kafka, Docker, Kubernetes
  \item OS: Linux
...
\begin{itemize}[parsep=0.5ex]
  ...
  \item Using Kafka as the middleware to address the data accumulate issue in high concurrency scenarios.
...
\datedsubsection{University of Detroit Mercy(UDM),  WSJ U.S Colledge Randed 47th}{2018 -- 2020}
